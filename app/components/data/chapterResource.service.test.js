...
describe('codex.data module', function() {
	...
	describe('chapter resource service', function() {
		
		var mockChapterResourceService, $httpBackend;
	
	    beforeEach(function () {
	        angular.mock.inject(function ($injector) {
	            $httpBackend = $injector.get('$httpBackend');
	            mockChapterResourceService = $injector.get('chapterResourceService');
	        });
	    });
		...
		describe('getChapters', function() {
			...
			it('should return null if fic id is null', function() {
				expect(mockChapterResourceService.getChapters(null)).toBeNull();
			});
			...
			it('should request the chapters api for a given fic', function() {
				...
				var result = mockChapterResourceService.getChapters(12);
		...
		describe('getChapter', function() {
			...
			it('should return null if fic id is null', function() {
				expect(mockChapterResourceService.getChapter(null, 1)).toBeNull();
			});
			
			it('should return null if chapter number is null', function() {
				expect(mockChapterResourceService.getChapter(1, null)).toBeNull();
			});
			...
			it('should request the api for the given fic and chapter', function() {
				...
				var result = mockChapterResourceService.getChapter(12, 3);
